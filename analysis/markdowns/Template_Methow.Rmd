...
```{r covariate-comparison, fig.cap = "Net error covariate values. Colors correspond to either the original study or the reaches where the model was used in this report (Predictive Data)."}
