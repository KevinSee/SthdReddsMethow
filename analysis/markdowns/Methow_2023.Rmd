...
HOR-C origin steelhead PIT-tagged at Priest Rapids dam were not detected in Libby Creek or at the Methow Fish Hatchery array this year, leading to estimates of zero spawners for those origins in those areas (Table \@ref(tab:spwn-area)). Because these estimates are based on a sample of the entire Upper Columbia steelhead run, it's possible that a low number of HOR-C steelhead may have spawned in those tributaries, but it's potentially more likely that the estimate of zero HOR-C steelhead spawners in those areas is correct.
