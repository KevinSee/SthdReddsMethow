...
This repository contains the code and reports detailing estimates of total steelhead redds in the Methow subbasin, after accounting for modeled observer error. 

## Contents

The **analysis** directory contains:

  - [:file\_folder: markdowns](/analysis/markdowns): R Markdown source document for reports. Includes code to reproduce the figures and tables in each year's report. 
  - [:file\_folder: R_scripts](/analysis/R_scripts): R code used to prep some data. 
...
- finally, open one of the `.Rmd` files in `analysis/markdowns` and knit to produce that report.
